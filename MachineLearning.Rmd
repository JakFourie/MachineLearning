...
Assignment:
The goal of this project is to predict the manner in which volunteers perform barbell lifts. This is the "classe" variable in the training set.
...
they do not contribute to the model.
...
A number of variables contain NA's.
...
The original set is large (19622 obs. of 56 variables). 
...
We do have a reduced number of rows.
